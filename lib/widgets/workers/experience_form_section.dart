...
class _ExperienceFormSectionState extends State<ExperienceFormSection> {
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Expanded(flex: 6, child: _buildJobInfoForm()),
            ...
            children: [
              ...
              Expanded(
                child: buildDropdownField(
                  ...
                  selectedValue: widget.experienceLevelController.text,
                  hint: 'enter_your_level'.tr(),
                  items: const ['Fresher', 'Junior', 'Mid-Level', 'Senior'],
  ...
  Widget _buildCalendarGrid(BuildContext context) {
    ...
    final padCount = firstWeekday == 7 ? 0 : firstWeekday;
    final trailingPadCount = 42 - (padCount + daysInMonth);
    ...
    return GridView.count(
      ...
      crossAxisSpacing: 4,
      children: [
        for (int i = 0; i < padCount; i++) const SizedBox.shrink(),
        for (int day = 1; day <= daysInMonth; day++)
          GestureDetector(
            ...
            onTap: () {
              ...
              final formatted = '$monthName ${selected.day}, ${selected.year}';
              widget.onJoiningDateChanged?.call(selected);
              setState(() {
            ...
            child: Builder(
              builder: (context) {
                ...
                return Container(
                  ...
                  decoration: BoxDecoration(
                    color: isSelected ? selectedBg : const Color(0xFFFFFFFF),
                    border: isSelected
                        ? null
                        : Border.all(
                            color: isSunday
        ...
        for (int i = 0; i < trailingPadCount; i++) const SizedBox.shrink(),
      ],
    );
  }
