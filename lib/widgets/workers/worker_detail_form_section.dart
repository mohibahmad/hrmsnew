...
class WorkerDetailFormSection extends StatelessWidget {
                      ...
                      children: [
                        Expanded(
                          child: GestureDetector(
                            onTap: () => _handleDobFieldTap(context),
                            child: AbsorbPointer(
                              child: buildInputField(
                                'worker_dob'.tr(),
                                'date_format'.tr(),
  ...
  void _handleDobFieldTap(BuildContext context) {
    final now = DateTime.now();
    final minimumDob = DateTime(1950);
    final maximumDob = DateTime(now.year - 18, now.month, now.day);
    ...
    _showCupertinoDatePicker(
      ...
      onDateSelected: (date) {
        ...
        onDobChanged?.call(DateTime(date.year, date.month, date.day));
      },
    );
  }
