...
Future<void> downloadTemplate(BuildContext context) async {
  const headerRow =
      ...
      'Salary Type,Salary Amount,Annual Leaves,Sick Leaves,Casual Leaves,'
  ...
  const dataRows =
      ...
      'Monthly,5000,15,10,5,5,1/15/2025,'
      ...
      'Monthly,6000,15,10,5,5,1/15/2025,'
      ...
      'Monthly,7500,15,10,5,5,1/15/2025,'
      ...
      'Monthly,8500,20,10,5,5,1/20/2025,'
      ...
      'Monthly,9500,18,10,5,5,2/1/2025,'
      ...
      'Monthly,7000,15,10,5,5,2/5/2025,'
      ...
      'Monthly,110000,20,10,5,5,1/10/2025,'
